...
this functions is called asynchronously and buffer will return http header details one at time
...
/*this callback function is used to get response body data  from a  http response in curl
    this function is called asynchronously  and http response data coming from void* ptr
